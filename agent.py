...
# Load defined tools
from tools.math_tools import add, multiply, exponentiate, subtract
...
tools = [add, subtract, multiply, exponentiate, final_answer, serpapi, retrieval_tool]
